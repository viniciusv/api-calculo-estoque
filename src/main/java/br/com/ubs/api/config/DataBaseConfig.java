...
public class DatabaseConfig {
	...
	private void instantiateTestDatabase() {
		...
		if(estoques.size() == 0) {
			Produto estoque = new Produto("EMMS", new Integer(74), new BigDecimal(3.75),"XL","Broadcasting", "TX", "data_1.json");
			Produto estoque1 = new Produto("EMMS", new Integer(36), new BigDecimal(5.29),"3XL","Broadcasting", "MN", "data_1.json");
			Produto estoque2 = new Produto("EMMS", new Integer(99), new BigDecimal(5.80),"2XL","Broadcasting", "MI", "data_1.json");
			Produto estoque3 = new Produto("EMMS", new Integer(61), new BigDecimal(7.45),"2XL","Broadcasting", "LA", "data_1.json");
